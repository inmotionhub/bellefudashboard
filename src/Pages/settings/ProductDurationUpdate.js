...
function ProductDurationUpdate() {
  ...
  const handleDurationUpdate = async (e) => {
    ...
    axios({
      method: "POST",
      url: `${APIDATA}update/product/duration`,
      data: formDatas,
      headers: {
  ...
  return (
    <div>
      <h5 className={css(styles.topHeader)}>Ads Duration Update</h5>
...
export default ProductDurationUpdate;
